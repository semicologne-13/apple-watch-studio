  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      ...
      size: {
        ...
        icon: "h-9 w-9",
        save: "py-2 px-4 rounded-full text-sm",
        started: "px-5 py-2.5 rounded-full mt-11 text-[17px]",
        modal:"w-full px-4 py-0 text-center h-9 px-4 py-2 rounded-lg transition-colors font-text text-[17px]",
        footer: "my-[5px] min-h-[20px] text-[17px] align-middle text-[#1d1d1f] py-[5px]"
      },
    },
    defaultVariants: {
      variant: "default",
